      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
                ...
                <div key={step.id} className="relative">
                  <div 
                    className={`bg-white rounded-2xl shadow-lg border-2 transition-all duration-300 cursor-pointer ${
                      isActive ? 'border-[#FF5F1F] shadow-xl scale-[1.02]' : 'border-slate-200 hover:border-slate-300'
                    }`}
        ...
        <section className="text-center">
          <div className="bg-gradient-to-br from-[#FF5F1F] to-[#D64D15] rounded-2xl shadow-2xl p-12">
            <h2 className="text-3xl font-bold text-white mb-4">Ready to Transform Reddit Reviews?</h2>
